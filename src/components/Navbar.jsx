    ...
    <>
        <div className='w-full flex justify-between items-center font-semibold'>
            ...
            <div className='flex items-center gap-4'>
                <p className='bg-white text-black text-[15px] px-4 py-1 rounded-2xl hidden md:block'>Explore Primium </p>
                <p className='bg-black py-1 px-3 rounded-2xl text-[15px] cursor-pointer'>Install App</p>
                <p className='bg-purple-500 text-black w-9 h-9 rounded-full flex items-center justify-center'>SG</p>
            </div>
        </div>
